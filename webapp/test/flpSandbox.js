		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Funzionalita Reimputazione",
									"targetURL": "#funzionalitareimputazione-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"funzionalitareimputazione-display": {
								"semanticObject": "funzionalitareimputazione",
								"action": "display",
								"description": "Funzionalita per la reimputazione",
								"title": "Funzionalita Reimputazione",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=funzionalitareimputazione",
									"url": sap.ui.require.toUrl("funzionalitareimputazione")
								}
							}
						}
					}
